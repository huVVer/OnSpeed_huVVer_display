...
#define PIN_CANTX 	GPIO_NUM_14			// CAN bus 
#define PIN_CANRX 	GPIO_NUM_27			// CAN bus 
#define PIN_CANRS 	22  				// CAN bus 
#define BUTTON_A    39  
#define BUTTON_B    36  
#define BUTTON_C    34  
#define BUTTON_D    35  
...
#define PIN_RX2 	16  				// Serial 2
#define S2INVERT	false				// huVVer devices have RS232 buffers  	  
#define PIN_CANTX 	GPIO_NUM_9			// CAN bus 
#define PIN_CANRX 	GPIO_NUM_33			// CAN bus 
#define PIN_CANRS 	14  				// CAN bus 
#define BUTTON_A    5
#define BUTTON_B    2
#define BUTTON_C    8
#define BUTTON_D    6
